          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-2 md:grid-cols-4">
              {allEntries.map((entry) => (
                <Link
                  ...
                  className="flex items-center gap-1.5 text-sm text-carbon-300 transition-colors hover:text-mint-500"
                >
            ...
            <div className="grid grid-cols-2 gap-4">
              <Link
                ...
                className="rounded-xl border border-carbon-600 bg-carbon-800 p-5 transition-colors hover:border-mint-500/50"
              >

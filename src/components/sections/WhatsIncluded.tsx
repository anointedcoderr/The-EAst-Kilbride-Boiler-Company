          ...
          <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => (
              <ScrollReveal key={feature.title} direction="up" delay={index * 0.1}>
                <div
                  className="hover-card relative rounded-xl border border-carbon-600 bg-carbon-800 p-6 transition-colors hover:border-mint-500/50"
                >
                  ...
                  <div className="hover-icon-glow mb-4 flex h-14 w-14 items-center justify-center rounded-full border border-mint-500/40 bg-carbon-900">

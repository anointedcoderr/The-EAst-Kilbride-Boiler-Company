        ...
        <div className="text-center">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg border border-mint-500 px-6 py-3 font-semibold text-mint-500 transition-colors hover:bg-mint-500/10"
            >

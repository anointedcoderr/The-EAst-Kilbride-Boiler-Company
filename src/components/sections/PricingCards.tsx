        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          {brands.map((brand, index) => (
            <ScrollReveal key={brand.id} direction="up" delay={index * 0.1}>
              <div className="hover-card flex flex-col overflow-hidden rounded-xl border border-carbon-600 bg-carbon-800 transition-colors hover:border-mint-500/50">
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <div className="mt-auto pt-5">
                    <Link
                      ...
                      className="flex w-full items-center justify-center rounded-lg border border-mint-500 px-6 py-3 text-sm font-semibold text-mint-500 transition-all hover:bg-mint-500/10 hover:scale-105"
                    >
                      Get This Deal
                    </Link>
                  </div>

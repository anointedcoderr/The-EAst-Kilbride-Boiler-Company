          ...
          <div>
            <div className="flex flex-col gap-8">
              {trustPoints.map((point) => (
                <div key={point.title} className="flex gap-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg border border-mint-500/40 bg-carbon-800">
            ...
            <div className="mt-10 grid grid-cols-3 gap-4">
              {stats.map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-lg border border-carbon-600 bg-carbon-800 p-4 text-center"
                >

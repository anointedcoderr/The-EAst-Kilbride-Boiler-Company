...
// ─────────────────────────────────────────────────────────────────────────────
// SITE PARKED — temporary holding page.
//
// While this file exists, EVERY request to the site returns the "Contact
// Anointed Coder" holding page below. The full website code is untouched and
// still in this repo (and snapshotted on the `full-site` branch).
//
// ▶ TO RESTORE THE LIVE SITE:
//     delete this file (src/middleware.ts) and push to `main`.
//     Hostinger auto-redeploys and the full website returns.
//
// The 503 status + Retry-After header tells search engines this is a temporary
// outage, so rankings recover cleanly once the site is restored. The page still
// renders normally in every browser.
// ─────────────────────────────────────────────────────────────────────────────
